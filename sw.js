const CACHE='private-office-static-v11';
const ASSETS=['./','./index.html','./styles.css','./workspace.css','./app.js','./workspace.js','./config.js','./file-controls.js','./manifest.webmanifest','./favicon.svg'];
