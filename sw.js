const CACHE='private-office-static-v14';
const ASSETS=['./','./index.html','./styles.css','./ui-polish.css','./workspace.css','./batch-upload.css','./app.js','./workspace.js','./batch-upload.js','./config.js','./file-controls.js','./manifest.webmanifest','./favicon.svg'];
