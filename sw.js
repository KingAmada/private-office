const CACHE='private-office-static-v12';
const ASSETS=['./','./index.html','./styles.css','./workspace.css','./batch-upload.css','./app.js','./workspace.js','./batch-upload.js','./config.js','./file-controls.js','./manifest.webmanifest','./favicon.svg'];
